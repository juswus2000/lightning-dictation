...
echo -e "${BLUE}============================================================${NC}"
echo ""
echo -e "${RED}IMPORTANT:${NC} Do not move or delete the ${BLUE}$SCRIPT_DIR${NC} folder."
echo "  The app links back to this folder — removing it will break the app."
echo ""
...
echo "     → In System Settings, the app may appear as ${BLUE}\"Python\"${NC} — this is normal"
echo ""
echo "  2. On your first recording, macOS will ask for ${BLUE}Microphone${NC} access"
echo "     → Click Allow"
echo ""
echo "  3. On first use, the AI model will download automatically (~500MB)"
echo "     → This requires internet for the first launch only"
echo ""
